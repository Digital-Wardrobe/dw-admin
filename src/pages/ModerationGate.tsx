    ...
    <div className="space-y-8 animate-fade-in">
      <div className="flex items-center justify-between border-b border-[#1E293B] pb-4">
        <div>
          ...
          <p className="text-sm text-ink-400">Monitor public vibes, posts, and comments flags to safeguard user interactions.</p>
        </div>
      </div>

      {/* Grid */}
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-2xl bg-ink-800 p-6 border border-[#1E293B] hover:border-red-500/10 transition-all">
          <div className="flex items-center justify-between text-ink-400 mb-2">
      ...
      <div className="rounded-2xl bg-ink-800 p-8 border border-[#1E293B] flex flex-col items-center justify-center min-h-[300px] text-center">
